...
// Also rejects anything outside an RFC-3986-ish path/query character set, so the
// value is safe to reflect into an HTML attribute or a JSON-in-<script> literal
// (no "<", ">", quotes, backtick, space or backslash survive).
