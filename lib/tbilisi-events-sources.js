...
// Each entry: { type: 'telegram' | 'website' | 'facebook' | 'facebook_group' | 'instagram' | 'tkt' | 'biletebi', value: string, label: string }
...
// tkt / biletebi: value is unused (both collectors hit the site's own API directly);
//   return structured events, no LLM extraction
module.exports = [
  ...
  { type: 'biletebi', value: 'https://biletebi.ge', label: 'biletebi.ge' },
];
