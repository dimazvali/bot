...
// ---------------- memories ----------------
var MEMORY_DEFAULTS = { description: '', ownerId: null, active: true, startLat: null, startLng: null };
...
// ---------------- memory photos ----------------
// orientation: compass bearing (0-360, 0=N/90=E/...) the photo's face points
// outward, e.g. "mounted on a wall" — null means the old billboard behavior
// (always faces the camera, no matter where the viewer stands).
var PHOTO_DEFAULTS = { caption: '', takenAt: null, orientation: null };
