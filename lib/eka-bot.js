  ...
  try {
    ...
    if (msg && msg.from && !msg.from.is_bot) {
      ...
      if (inText || inMediaType) {
        ...
        saveMessage(msg.from.id, inMsg).then(function() {
...
module.exports = { init, setWebhook, getBotProfile, setBotProfile, setBotPhoto, registerUser, markInactive, markActive, sendMessage, sendMedia, forwardMessage, saveMessage, getUsers, getBotMessages, saveBotMessages, handleUpdate };
