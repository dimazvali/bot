...
async function handleUpdate(update, onNewMessage, onCommand) {
  try {
...
module.exports = { init, setWebhook, getBotProfile, setBotProfile, setBotPhoto, registerUser, markInactive, markActive, sendMessage, sendMedia, forwardMessage, getUsers, getBotMessages, saveBotMessages, handleUpdate };
