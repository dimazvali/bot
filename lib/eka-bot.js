...
// onNewMessage(fromId, fromLabel, text, rawMsg) — called for non-/start messages.
async function handleUpdate(update, onNewMessage) {
  try {
...
module.exports = { init, setWebhook, registerUser, markInactive, markActive, sendMessage, sendMedia, getUsers, getBotMessages, saveBotMessages, handleUpdate };
