...
var UI = {
  ru: {
    ...
    onSite: 'На сайт события', readMore: 'Подробнее', sourcesLabel: 'Источники',
  ...
  en: {
    ...
    onSite: 'Event website', readMore: 'Read more', sourcesLabel: 'Sources',
  ...
  ka: {
    ...
    onSite: 'ღონისძიების საიტი', readMore: 'ვრცლად', sourcesLabel: 'წყაროები',
