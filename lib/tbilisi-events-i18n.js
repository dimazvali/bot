...
var UI = {
  ru: {
    ...
    orgYouAre: 'Вы организатор ✓', orgPending: 'Заявка на рассмотрении', orgClaim: 'Я организатор',
    footer: 'Афиша Тбилиси от редакции: выбираем руками, а не по алгоритму. Обновляем по мере сбора.',
    venuesTitle:'Интересные места Тбилиси', address:'Адрес', city:'Город', district:'Район', venueType:'Тип', website:'Сайт', allVenueEvents:'Все события площадки', venuePoster:'Афиша', routeMap:'Маршрут в Google Maps', otherVenues:'Другие площадки', nothingHere:'Здесь пока нет предстоящих событий', eventsWord:'событий', ofWord:'из', search:'Поиск по событиям и местам', venueClosed:'Закрыто', venueClosedSince:'Закрыто с',
    hours:'Часы работы', editorsPickTag:'★ Выбор редакции', gallery:'Фото', otherDates:'Другие даты',
    allChip: 'Все',
    collectionsTitle: 'Кураторские подборки', curatedBy: 'Подборка:', collectionsEmpty: 'Пока нет подборок', backToCollections: '← Подборки', collectionEmpty: 'В подборке пока нет событий', authorOrder: 'Порядок — авторский, а не хронологический', whyGo: 'Почему стоит пойти', otherCollections: 'Другие подборки', period: 'Период', updatedLabel: 'Обновлено', routeLabel: 'Маршрут подборки', mapPoints: 'точек',
  ...
  en: {
    ...
    orgYouAre: 'You’re the organizer ✓', orgPending: 'Organizer request pending', orgClaim: 'I’m the organizer',
    footer: 'What’s on in Tbilisi, picked by our editors — no algorithms. Updated as we collect.',
    venuesTitle:'Tbilisi venues', address:'Address', city:'City', district:'District', venueType:'Type', website:'Website', allVenueEvents:'All venue events', venuePoster:'Programme', routeMap:'Route in Google Maps', otherVenues:'Other venues', nothingHere:'No upcoming events here yet', eventsWord:'events', ofWord:'of', search:'Search events and places', venueClosed:'Closed', venueClosedSince:'Closed since',
    hours:'Opening hours', editorsPickTag:'★ Editors’ pick', gallery:'Photos', otherDates:'Other dates',
    allChip: 'All',
    collectionsTitle: 'Curated collections', curatedBy: 'Curated by:', collectionsEmpty: 'No collections yet', backToCollections: '← Collections', collectionEmpty: 'No events in this collection yet', authorOrder: 'Curator’s order, not chronological', whyGo: 'Why go', otherCollections: 'Other collections', period: 'Dates', updatedLabel: 'Updated', routeLabel: 'Collection route', mapPoints: 'stops',
  ...
  ka: {
    ...
    orgYouAre: 'თქვენ ხართ ორგანიზატორი ✓', orgPending: 'განაცხადი განიხილება', orgClaim: 'მე ვარ ორგანიზატორი',
    footer: 'თბილისის აფიშა რედაქციისგან: ხელით შერჩეული, ალგორითმის გარეშე.',
    venuesTitle:'თბილისის ადგილები', address:'მისამართი', city:'ქალაქი', district:'უბანი', venueType:'ტიპი', website:'საიტი', allVenueEvents:'ადგილის ყველა ღონისძიება', venuePoster:'აფიშა', routeMap:'მარშრუტი Google Maps-ში', otherVenues:'სხვა ადგილები', nothingHere:'აქ ჯერ არ არის დაგეგმილი ღონისძიებები', eventsWord:'ღონისძიება', ofWord:'-დან', search:'ძებნა ღონისძიებებსა და ადგილებში', venueClosed:'დაკეტილია', venueClosedSince:'დაკეტილია',
    hours:'სამუშაო საათები', editorsPickTag:'★ რედაქციის არჩევანი', gallery:'ფოტოები', otherDates:'სხვა თარიღები',
    allChip: 'ყველა',
    collectionsTitle: 'კურატორის კრებულები', curatedBy: 'კურატორი:', collectionsEmpty: 'ჯერ არ არის კრებულები', backToCollections: '← კრებულები', collectionEmpty: 'ამ კრებულში ჯერ ღონისძიებები არ არის', authorOrder: 'თანმიმდევრობა ავტორისეულია, არა ქრონოლოგიური', whyGo: 'რატომ ღირს', otherCollections: 'სხვა კრებულები', period: 'პერიოდი', updatedLabel: 'განახლდა', routeLabel: 'კრებულის მარშრუტი', mapPoints: 'წერტილი',
...
// Nominative month names — for standalone labels like the calendar header.
var MONTH_NOM = {
...
var VENUE_TYPE_LABELS = {
  ...
  en: {
    ...
    club: 'club / bar', restaurant: 'restaurant', museum: 'museum', openair: 'open-air', other: 'other',
  },
  ka: {
    concert_hall: 'საკონცერტო დარბაზი', gallery: 'გალერეა', theatre: 'თეატრი',
    club: 'კლუბი / ბარი', restaurant: 'რესტორანი', museum: 'მუზეუმი', openair: 'ღია ცის ქვეშ', other: 'სხვა',
  },
};
...
// "+N more dates" badge on a card that represents a recurring event's series.
function moreDatesLabel(n, lang) {
  if (lang === 'ru') return '+' + n + ' ' + pluralRu(n, ['дата', 'даты', 'дат']);
  if (lang === 'ka') return '+' + n + ' თარიღი';
...
// Monday-first weekday keys, as stored on venue.hours ({ mon: '10:00–20:00', ... }).
var DAY_KEYS = ['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'];
// WD_SHORT is Sunday-first (index = Date#getUTCDay()); map each day key to it.
var DAY_KEY_TO_WD_INDEX = { mon: 1, tue: 2, wed: 3, thu: 4, fri: 5, sat: 6, sun: 0 };
function dayKeyLabel(key, lang) {
  return WD_SHORT[lang][DAY_KEY_TO_WD_INDEX[key]] || key;
}
