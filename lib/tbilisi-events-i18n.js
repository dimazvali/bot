...
var UI = {
  ru: {
    ...
    allChip: 'Все',
    collectionsTitle: 'Кураторские подборки', curatedBy: 'Подборка:', collectionsEmpty: 'Пока нет подборок', backToCollections: '← Подборки', collectionEmpty: 'В подборке пока нет событий',
  },
  en: {
    brandTail: 'Events',
    ...
    allChip: 'All',
    collectionsTitle: 'Curated collections', curatedBy: 'Curated by:', collectionsEmpty: 'No collections yet', backToCollections: '← Collections', collectionEmpty: 'No events in this collection yet',
  },
  ka: {
    brandTail: 'Events',
    ...
    allChip: 'ყველა',
    collectionsTitle: 'კურატორის კრებულები', curatedBy: 'კურატორი:', collectionsEmpty: 'ჯერ არ არის კრებულები', backToCollections: '← კრებულები', collectionEmpty: 'ამ კრებულში ჯერ ღონისძიებები არ არის',
  },
};
