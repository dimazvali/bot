...
async function updatePhoto(slug, photoId, fields) {
  var env = getEnv();
  var safe = { title: fields.title || '', date: fields.date || '', desc: fields.desc || '', type: ['copter','camera','mobile'].includes(fields.type) ? fields.type : 'copter' };
...
module.exports = { initFromFirestore, getData, getShoot, createShoot, saveShoot, addPhoto, updatePhoto, removePhoto, reorderPhotos, addAnnotation, moveAnnotation, removeAnnotation, deleteShoot };
