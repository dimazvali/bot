...
var UI = {
  ru: {
    allWorks: 'ВСЕ РАБОТЫ', photosSuffix: 'фото', shuffle: '↺ ШАФЛ', tagPrefix: 'ТЕГ:',
    allShoots: 'все съемки', download: '↓ СКАЧАТЬ', addPhoto: '+ фото', editSeries: '✎ серия',
    ...
    langSwitch: 'EN',
    addPoint: '+ ТОЧКА', pointPopupTitle: 'ЧТО ЗДЕСЬ?', pointPlaceholder: 'например: это моя любимая деталь',
    pointAuthorPrefix: 'клиент:',
  },
  en: {
    allWorks: 'ALL WORKS', photosSuffix: 'photos', shuffle: '↺ SHUFFLE', tagPrefix: 'TAG:',
    allShoots: 'all shoots', download: '↓ DOWNLOAD', addPhoto: '+ photo', editSeries: '✎ series',
    ...
    langSwitch: 'RU',
    addPoint: '+ POINT', pointPopupTitle: "WHAT'S HERE?", pointPlaceholder: "e.g. this is my favorite detail",
